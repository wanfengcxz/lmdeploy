...
from lmdeploy.pytorch.kernels.camb import rms_norm

from ..norm import RMSNormBuilder, RMSNormImpl


class CambRMSNormImpl(RMSNormImpl):
    """camb RMS norm implementation."""
...
class CambRMSNormBuilder(RMSNormBuilder):
    """camb RMS norm implementation builder."""
